...
## We have updated the cell subtype template file (from .csv files to .rds file)
## You may refer to scCancer2.rmd (set other modules as "FALSE" for using cell type and cell subtype annotation only.)
