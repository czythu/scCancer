...
anno.results <- runScAnnotation(
    ...
    malignancy.method = "both", # Or: "inferCNV", "both"
    bool.intraTumor = T,
    bool.runCellCycle = F,
    bool.runStemness = F,
    bool.runGeneSets = F,
...
```{r}
samples <- c('CC009', 'cc006', 'YS2306057_AV_230615', 'YS2306057_BD_230615', 'YS2306057_NL_230615',
             'YS2306060_AV_230615', 'YS2306060_NL_230615', 'icc010',
             '20200208-PAC-CRR034523-N4-Normal', '20200208-PAC-CRR034524-N5-Normal',
             '20180625-HCC-P4-Tumor-New', '20181024-KC-P7-Tumor-vCR3',
             '20200208-PAC-CRR034517-T22-Tumor', 
             'cc001', 'cc003', 'cc002')
