...
# path <- "D:/scCancer-data/SubtypeAnno/Demo-pipeline/GSE140228/"
# path <- "D:/scCancer-data/SubtypeAnno/Demo-pipeline/CRA001160/"
path <- "D:/scCancer-data/SubtypeAnno/Demo-pipeline/STAD-ascites-2/"
...
for (sample in samples){
    ...
    anno.results <- runScAnnotation(
        ...
        subtype.umap = T,
        bool.runMalignancy = T,
        malignancy.method = "xgboost", # or "inferCNV", "both", recommend "both" for single sample
        bool.intraTumor = T,
        bool.runCellCycle = T,
        bool.runStemness = T,
        bool.runGeneSets = T,
        bool.runExprProgram = F, # False to save time
