...
anno.results <- runScAnnotation(
    ...
    malignancy.method = "xgboost", # "xgboost", "inferCNV", "both"
    bool.intraTumor = T,
    bool.runCellCycle = F,
    bool.runStemness = F,
    bool.runGeneSets = F,
...
```{r}
samples <- c('20200215-HCC-Pt14d-Tumor', '20200208-PAC-CRR034517-T22-Tumor',
...
samples <- c('20200208-PAC-CRR034523-N4-Normal', '20200208-PAC-CRR034524-N5-Normal', 
             'YS2306057_AV_230615', '20181024-KC-P7-Tumor-vCR3', 'cc001',
             'YS2306057_BD_230615', '20200208-PAC-CRR034524-N5-Normal', 
             'cc002', '20200208-PAC-CRR034517-T22-Tumor',
             '20180625-HCC-P4-Tumor-New')
