...
```{r cellSubType, child=system.file("rmd", "cellSubType.Rmd", package = "scCancer2"), eval = results$bool.runCellSubtypeClassify}
```




```{r malignancy, child=system.file("rmd", "malignancy.Rmd", package = "scCancer2"), eval = results$bool.runMalignancy}
```




```{r malignancy-xgboost, child=system.file("rmd", "malignancy-xgboost.Rmd", package = "scCancer2"), eval = results$bool.runMalignancy}
```
